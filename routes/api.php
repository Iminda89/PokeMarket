...
use App\Http\Controllers\MessageController; // Añadido el nuevo controlador
...
Route::middleware(['auth:sanctum', 'admin'])->prefix('admin')->group(function () {
    ...
    // --- NUEVO: Gestión de Mensajes / Tickets (Admin) ---
    Route::get('/messages/users', [MessageController::class, 'getUsersWithTickets']);
    Route::get('/messages/user/{id}', [MessageController::class, 'getUserMessages']);
